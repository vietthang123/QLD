...
import INTER.IBangDiemDAO;
import INTER.ILopHocDAO;
import INTER.IMonHocDAO;
import INTER.ISinhVienDAO;
...
public class frmBangDiem extends javax.swing.JPanel {
    ...
    public void loadData() {
        ...
        try {
            IBangDiemDAO bangDiemDAO = (IBangDiemDAO) Class.forName("DAO.BangDiemDAO").newInstance();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jcbMaMH, 0, 276, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jtfDiem, javax.swing.GroupLayout.DEFAULT_SIZE, 49, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jrbTrangthai, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jcbHeSo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(25, 25, 25))
        );
        ...
        btnsave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/folder/Upload.png"))); // NOI18N
    ...
    private void tblbangdiemMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbangdiemMouseReleased
        jcbMasv.setSelectedItem(tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 0).toString());
        jcbMaMH.setSelectedItem(tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 1).toString());
        jcbLanthi.setSelectedItem(tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 2).toString());
        jcbHeSo.setSelectedItem(tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 3).toString());
        jtfDiem.setText(tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 4).toString());
        String trangthai = tblbangdiem.getValueAt(tblbangdiem.getSelectedRow(), 5).toString();
